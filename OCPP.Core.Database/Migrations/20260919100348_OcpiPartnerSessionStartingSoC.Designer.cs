...
namespace OCPP.Core.Database.Migrations
{
    ...
    [Migration("20260919100348_OcpiPartnerSessionStartingSoC")]
    partial class OcpiPartnerSessionStartingSoC
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OCPP.Core.Database.EVCDTO.ChargingGuns", b =>
                {
                    b.Property<string>("RecId")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<string>("ChargerMeterReading")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<string>("ChargerTariff")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("OCPP.Core.Database.EVCDTO.ChargingSession", b =>
                {
                    ...
                    b.Property<double?>("BatteryIncreaseLimit")
                        .HasColumnType("float");
                    ...
                    b.Property<double?>("SoCEnd")
                        .HasColumnType("float");

                    b.Property<DateTime?>("SoCLastUpdate")
                        .HasColumnType("datetime2");

                    b.Property<double?>("SoCStart")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("OCPP.Core.Database.EVCDTO.OtpValidation", b =>
                {
                    b.Property<string>("RecId")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("OCPP.Core.Database.EVCDTO.PaymentValidation", b =>
                {
                    b.Property<string>("RecId")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("OCPP.Core.Database.EVCDTO.ServiceTicket", b =>
                {
                    b.Property<string>("RecId")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.HasIndex(new[] { "Status" }, "IX_ServiceTicket_Status");

                    b.HasIndex(new[] { "ServiceTicketId" }, "IX_ServiceTicket_TicketId")
                        .IsUnique();

                    b.HasIndex(new[] { "UserId" }, "IX_ServiceTicket_UserId");

                    b.ToTable("ServiceTicket", (string)null);
                });

            modelBuilder.Entity("OCPP.Core.Database.EVCDTO.SessionInvoice", b =>
                {
                    b.Property<string>("RecId")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<string>("BilledToEmail")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.Property<string>("BilledToPhone")
                        .HasMaxLength(30)
                    ...
                    b.ToTable("SessionInvoice", (string)null);
                });
            ...
            modelBuilder.Entity("OCPP.Core.Database.OCPIDTO.OcpiCdr", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("PartnerCredentialId")
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("TotalCostExclVat")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("TotalCostInclVat")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("TotalEnergy")
                        .HasColumnType("decimal(18,4)");

                    b.Property<decimal?>("TotalParkingTime")
                        .HasColumnType("decimal(18,4)");
                    ...
                    b.HasIndex("PartnerCredentialId");

                    b.HasIndex("CountryCode", "PartyId", "CdrId")
                        .IsUnique()
                        .HasDatabaseName("IX_OcpiCdr_CountryCode_PartyId_CdrId");

                    b.ToTable("OcpiCdr", (string)null);
                });

            modelBuilder.Entity("OCPP.Core.Database.OCPIDTO.OcpiHostedSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal?>("StartingStateOfCharge")
                        .HasColumnType("decimal(5,2)");
                    ...
                    b.ToTable("OcpiHostedSession", (string)null);
                });

            modelBuilder.Entity("OCPP.Core.Database.OCPIDTO.OcpiPartnerConnector", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("MaxElectricPower")
                        .HasColumnType("int");

                    b.Property<int?>("MaxVoltage")
                        .HasColumnType("int");

                    b.Property<int>("PartnerEvseId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("TariffIds")
                        .HasMaxLength(400)
                        .HasColumnType("nvarchar(400)");

                    b.HasKey("Id");

                    b.HasIndex("PartnerEvseId", "ConnectorId")
                        .IsUnique()
                        .HasDatabaseName("IX_OcpiPartnerConnector_EvseId_ConnectorId");

                    b.ToTable("OcpiPartnerConnector", (string)null);
                });

            modelBuilder.Entity("OCPP.Core.Database.OCPIDTO.OcpiPartnerCredential", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CountryCode", "PartyId", "Role")
                        .IsUnique()
                        .HasDatabaseName("IX_OcpiPartnerCredential_Role_CountryCode_PartyId")
                        .HasFilter("[IsActive] = 1");

                    b.ToTable("OcpiPartnerCredential", (string)null);
                });

            modelBuilder.Entity("OCPP.Core.Database.OCPIDTO.OcpiPartnerEvse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("OcpiPartnerEvse", (string)null);
                });

            modelBuilder.Entity("OCPP.Core.Database.OCPIDTO.OcpiPartnerLocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CountryCode", "PartyId", "LocationId")
                        .IsUnique()
                        .HasDatabaseName("IX_OcpiPartnerLocation_CountryCode_PartyId_LocationId");

                    b.ToTable("OcpiPartnerLocation", (string)null);
                });

            modelBuilder.Entity("OCPP.Core.Database.OCPIDTO.OcpiPartnerPlatformFee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("OcpiPartnerPlatformFee", (string)null);
                });

            modelBuilder.Entity("OCPP.Core.Database.OCPIDTO.OcpiPartnerSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("LimitViolationHandled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
                    ...
                    b.HasIndex("CountryCode", "PartyId", "SessionId")
                        .IsUnique()
                        .HasDatabaseName("IX_OcpiPartnerSession_CountryCode_PartyId_SessionId");

                    b.ToTable("OcpiPartnerSession", (string)null);
                });

            modelBuilder.Entity("OCPP.Core.Database.OCPIDTO.OcpiPartnerSessionInvoice", b =>
                {
                    b.Property<string>("RecId")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<int>("OcpiPartnerSessionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("OcpiPartnerSessionId")
                        .IsUnique()
                        .HasDatabaseName("IX_OcpiPartnerSessionInvoice_OcpiPartnerSessionId");

                    b.HasIndex("UserId");

                    b.ToTable("OcpiPartnerSessionInvoice", (string)null);
                });

            modelBuilder.Entity("OCPP.Core.Database.OCPIDTO.OcpiPendingRegistration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("OcpiPendingRegistrations");
                });

            modelBuilder.Entity("OCPP.Core.Database.OCPIDTO.OcpiTariff", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CountryCode", "PartyId", "TariffId")
                        .IsUnique()
                        .HasDatabaseName("IX_OcpiTariff_CountryCode_PartyId_TariffId");

                    b.ToTable("OcpiTariff", (string)null);
                });

            modelBuilder.Entity("OCPP.Core.Database.OCPIDTO.OcpiToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal?>("EnergyContract")
                        .HasColumnType("decimal(18,4)");
                    ...
                    b.HasIndex("CountryCode", "PartyId", "TokenUid")
                        .IsUnique()
                        .HasDatabaseName("IX_OcpiToken_CountryCode_PartyId_TokenUid");

                    b.ToTable("OcpiToken", (string)null);
                });
            ...
            modelBuilder.Entity("OCPP.Core.Database.EVCDTO.ChargingGuns", b =>
                {
                    b.HasOne("OCPP.Core.Database.EVCDTO.ChargerTypeMaster", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OCPP.Core.Database.EVCDTO.ChargingSession", b =>
                {
                    b.HasOne("OCPP.Core.Database.EVCDTO.UserVehicle", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OCPP.Core.Database.OCPIDTO.OcpiCdr", b =>
                {
                    b.HasOne("OCPP.Core.Database.OCPIDTO.OcpiPartnerCredential", "PartnerCredential")
                        .WithMany()
                        .HasForeignKey("PartnerCredentialId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("FK_OcpiCdr_PartnerCredential");

                    b.Navigation("PartnerCredential");
                });
            ...
            modelBuilder.Entity("OCPP.Core.Database.OCPIDTO.OcpiPartnerConnector", b =>
                {
                    b.HasOne("OCPP.Core.Database.OCPIDTO.OcpiPartnerEvse", "PartnerEvse")
                        .WithMany()
                        .HasForeignKey("PartnerEvseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_OcpiPartnerConnector_PartnerEvse");

                    b.Navigation("PartnerEvse");
                });

            modelBuilder.Entity("OCPP.Core.Database.OCPIDTO.OcpiPartnerEvse", b =>
                {
                    b.HasOne("OCPP.Core.Database.OCPIDTO.OcpiPartnerLocation", "PartnerLocation")
                        .WithMany()
            ...
            modelBuilder.Entity("OCPP.Core.Database.OCPIDTO.OcpiPartnerSessionInvoice", b =>
                {
                    b.HasOne("OCPP.Core.Database.OCPIDTO.OcpiPartnerSession", null)
                        .WithMany()
                        .HasForeignKey("OcpiPartnerSessionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
